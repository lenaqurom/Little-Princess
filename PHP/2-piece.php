...
<head>
    ...
    <title>Little Princess | 2 Piece</title>
    ...
    <style>
        ...
        #hero {
            background: url("../image/k5.jpg") center center no-repeat;
    ...
    <section id="Flowers_cards">
        <div class="main">
            ...
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>85₪</p>
                        <button value="1 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="title">
                        <h1>2-piece Cotton Set</h1>
                    </div>
                    <div class="des">
                        <p>85₪</p>
                        <button value="2 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="title">
                        <h1>2-piece Printed Set</h1>
                    </div>
                    <div class="des">
                        <p>85₪</p>
                        <button value="3 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="des">
                        <p>85₪</p>
                        <button value="4 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="title">
                        <h1>2-piece Cotton Sweatshirt Set</h1>
                    </div>
                    <div class="des">
                        <p>110₪</p>
                        <button value="5 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="des">
                        <p>120₪</p>
                        <button value="6 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="des">
                        <p>100₪</p>
                        <button value="7 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="des">
                        <p>60₪</p>
                        <button value="8 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                    ...
                    <div class="title">
                        <h1>2-piece Set with Cotton Tank Top and Shorts</h1>
                    </div>
                    <div class="des">
                        <p>50₪</p>
                        <button value="9 head" name="flowerType" >Click here..</button>
                    </div>
                </form></div>
            ...
            <!----> <?php
            try{
                $dp= new mysqli('localhost', 'root', '','special' );
                $qryStr= "select * from thinkPic";
                $res= $dp->query($qryStr);
                $e=3;
                for($i=0;$i<$res->num_rows;$i++) {
                    $row = $res->fetch_object();
                    ...
                    echo'<form action="buy.php" method="post">
                            ...
                            <div class="des">
                                <p>'.$row->price.'₪</p>
                               <button value="'.$row->flowerID.' thinkpic" name="flowerType">Click here..</button>
                            </div>
                        </form>';
                    echo'</div>';
                }
...
<div id="popup" class="center">
    <div  class="warp">
        <label onclick="c()" class="close-btn fas fa-times" title="close"></label>
        <div class="text">Login</div>
        <form action="2-piece.php" method="post">
            <div class="field">
                <input type="text" name="txtUserLogin"required>
            ...
            <div class="signup-link">
                Not a member? <a href="../PHP/Registration.php">Signup now</a></div>
        </form>
    </div>
</div>
</body>
