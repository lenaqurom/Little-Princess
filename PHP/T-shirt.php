...
<head>
    ...
    <title>Little Princess | T-shirt</title>
    ...
    <style>
        ...
        #hero {
            background: url("../image/k3.jpg") center center no-repeat;
...
<div id="all">
    <div id="header-hero-container">
        ...
        <section id="hero">
            <div class="hero-text">
                <!--                <h1>Birthday Best Sellers</h1>-->
                <!--                <p>Blow out the candles and make a wish with our best selling birthday gifts!</p>-->
            </div>
        </section>
    </div>
    ...
    <section id="Flowers_cards">
        <div class="main">
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>50₪</p>
                        <button value="1 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>35₪</p>
                        <button value="2 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>25₪</p>
                        <button value="3 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>20₪</p>
                        <button value="4 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="title">
                        <h1>Motif-front T-shirt</h1>
                    </div>
                    <div class="des">
                        <p>35₪</p>
                        <button value="5 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="title">
                        <h1>Glitter-print T-shirt</h1>
                    </div>
                    <div class="des">
                        <p>30₪</p>
                        <button value="6 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>35₪</p>
                        <button value="7 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>25₪</p>
                        <button value="8 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>25₪</p>
                        <button value="9 ring" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            ...
            try{
                ...
                $qryStr= "select * from birthdayPic";
                $res= $dp->query($qryStr);
                $e=3;
                for($i=0;$i<$res->num_rows;$i++) {
                    $row = $res->fetch_object();
                    ...
                    echo'<form action="buy.php" method="post">
                            ...
                            <div class="des">
                                <p>'.$row->price.'₪</p>
                               <button value="'.$row->flowerID.' birthdaypic" name="flowerType">Click here..</button>
                            </div>
                        </form>';
                    echo'</div>';
                }
    ...
    <footer>
        ...
        <small>
            Copyright &copy; 2022 All rights reserved | Little Princess | made by Lina
        </small>
    </footer>
</div>
<script>
