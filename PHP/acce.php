...
<head>
    ...
    <title>Little Princess | Accessories</title>
    ...
    <style>
        ...
        #hero {
            background: url("../image/wepik-2022329-84931.png") center center no-repeat;
                ...
                <nav>
                    ...
                    <div class="h">
                        ...
                        <ul class ="nav-menu" id="nav-menu">
                            ...
                            <li><a href="T-shirt.php">Shoes</a></li>
                            <li>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="row">
                                            <ul class="mega-links">
                                                ...
                                                <li><a href="Shoes.php" >Jeans</a></li>
                                                <li><a href="Jeans.php">T-shirt</a></li>
                                            </ul>
                                        </div>
                                        <div class="row">
                                            <ul class="mega-links">
                                                ...
                                                <li><a href="T-shirt.php" >Accessories</a></li>
                                            </ul>
                                        </div>
    ...
    <section id="Flowers_cards">
        <div class="main" >
            ...
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-04-27 (2).png">
                    </div>
                    <div class="title">
                        <h1>3-pack hairbands</h1>
                    </div>
                    <div class="des">
                        <p>140₪</p>
                        <button value="1 acc" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <!--            ///////////////////-->
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-04-27 (1).png">
                    </div>
                    <div class="title">
                        <h1>Cotton twill bucket hat</h1>
                    </div>
                    <div class="des">
                        <p>350₪</p>
                        <button value="4 acc" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <!--            ///////////////////////////////-->
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-04-27 (3).png">
                    </div>
                    <div class="title">
                        <h1>Embroidered straw hat</h1>
                    </div>
                    <div class="des">
                        <p>200₪</p>
                        <button value="2 acc" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <!--            /////////////////////////////////////-->
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-04-27 (4).png">
                    </div>
                    <div class="title">
                        <h1>10-pack hair clips</h1>
                    </div>
                    <div class="des">
                        <p>100₪</p>
                        <button value="3 acc" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <!--            //////////////////////////////////////////-->
            ...
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-04-27 (5).png">
                    </div>
                    <div class="title">
                        <h1>2-pack sun glasses</h1>
                    </div>
                    <div class="des">
                        <p>180₪</p>
                        <button value="5 acc" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-04-27 (6).png">
                    </div>
                    <div class="title">
                        <h1>Water bottle</h1>
                    </div>
                    <div class="des">
                        <p>70₪</p>
                        <button value="6 acc" name="flowerType">Click here..</button>
                    </div>
                </form></div>

            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-05-05 (3).png">
                    </div>
                    <div class="title">
                        <h1>35-piece hair set</h1>
                    </div>
                    <div class="des">
                        <p>50₪</p>
                        <button value="6 acc" name="flowerType">Click here..</button>
            ...
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-05-05 (4).png">
                    </div>
                    <div class="title">
                        <h1>Set with a bag and sun visor</h1>
                    </div>
                    <div class="des">
                        <p>100₪</p>
                        <button value="6 acc" name="flowerType">Click here..</button>
            ...
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/2022-05-05 (5).png">
                    </div>
                    <div class="title">
                        <h1>Decorated sunglasses</h1>
                    </div>
                    <div class="des">
                        <p>120₪</p>
                        <button value="6 acc" name="flowerType">Click here..</button>
