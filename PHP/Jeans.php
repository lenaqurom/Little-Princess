...
<head>
    ...
    <title>Little Princess | Jeans</title>
    ...
    <style>
        ...
        #hero {
            background: url("../image/k1.jpg") center center no-repeat;
    ...
    <section id="Flowers_cards">
        <div class="main" >
            ...
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j22.jpg">
                    </div>
                    <div class="title">
                        <h1>2-pack Slim Fit Superstretch Jeans</h1>
                    </div>
                    <div class="des">
                        <p>110₪</p>
                        <button value="1 flower" name="flowerType">Click here..</button>
                    </div>
                </form>
            </div>
            <!--            ///////////////////-->
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>65₪</p>
                        <button value="2 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <!--            ///////////////////////////////-->
            <div class="card"><form action="buy.php" method="post">
                    ...
                    <div class="des">
                        <p>70₪</p>
                        <button value="3 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <!--            /////////////////////////////////////-->
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j14.jpg">
                    </div>
                    <div class="title">
                        <h1>Relaxed Fit High Jeans</h1>
                    </div>
                    <div class="des">
                        <p>100₪</p>
                        <button value="4 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <!--            //////////////////////////////////////////-->
            ...
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j8.jpg">
                    </div>
                    <div class="title">
                        <h1>Flare Fit Jeans</h1>
                    </div>
                    <div class="des">
                        <p>65₪</p>
                        <button value="5 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j9.jpg">
                    </div>
                    <div class="title">
                        <h1>Relaxed Fit High Jeans</h1>
                    </div>
                    <div class="des">
                        <p>65₪</p>
                        <button value="6 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div>
            <div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j11.jpg">
                    </div>
                    <div class="title">
                        <h1>Denim Overalls</h1>
                    </div>
                    <div class="des">
                        <p>110₪</p>
                        <button value="7 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div><div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j13.jpg">
                    </div>
                    <div class="title">
                        <h1>Denim Overalls</h1>
                    </div>
                    <div class="des">
                        <p>110₪</p>
                        <button value="8 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div><div class="card"><form action="buy.php" method="post">
                    <div class="image">
                        <img src="../image/j15.jpg">
                    </div>
                    <div class="title">
                        <h1>Pink Invitation</h1>
                    </div>
                    <div class="des">
                        <p>3₪</p>
                        <button value="9 flower" name="flowerType">Click here..</button>
                    </div>
                </form></div>
