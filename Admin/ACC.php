...
if(isset($_POST['add'])){
    ...
    if ($error == 0) {
        ...
        if (in_array($img_ex_lc, $allowed_exs)) {
            ...
            $query = "INSERT INTO acc (URL, name, price)
...
<header>
    ...
    <nav >
        <div class="nav-wrapper bg-secondary text-white "  style="background: #0e0e0e" >
            ...
            <a class="breadcrumb" style="color: #ffffff">Accessories</a>
...
<main>
    ...
    <div class="form-popup" id="myForm1" style="padding: 30px">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-container" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="button" name="add" value="yellowpic">Add</button>
    ...
    <div id="mainDiv" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Accessories Table</a>
                ...
                try {
                    ...
                    for($i=0;$i<$res->num_rows;$i++) {
                        ...
                        <tr>
                            ...
                            <td><button name="flowerType" type="submit" value="'.$row->ID. ' acc" style="color:  #ffffff ; background-color: #7a0202 ;" id="openform2" >Edit</button></td>
                        </tr>';
                        }
                        else{
                            $u = $row->URL;
                        ...
                        <tr>
                            ...
                            <td><button name="flowerType" type="submit" value="'.$row->ID. ' acc" style="color: white; background-color: #7a0202;" id="openform2" >Edit</button></td>
                        </tr>';
                        }
                    }
                }
