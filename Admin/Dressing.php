...
if(isset($_POST['add'])){
    ...
    if ($error == 0) {
        ...
        if (in_array($img_ex_lc, $allowed_exs)) {
            ...
            $query = "INSERT INTO dress (URL, name, price)
...
<head>
    ...
    <title>Little Princess | Dresses </title>
...
<header>
    ...
    <nav >
        <div class="nav-wrapper bg-secondary text-white "  style="background: #0e0e0e" >
            ...
            <a class="breadcrumb" style="color: #ffffff">Dresses</a>
...
<main>
    ...
    <div class="form-popup" id="myForm1" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Add Dress</a>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-container" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="button" name="add" value="dress">Add</button>
    ...
    <div class="form-popup2" id="myForm2" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Edit categories</a>
        <form action="Rings.php" class="form-container2">
    ...
    <div id="mainDiv" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Dresses</a>
                ...
                try{
                    ...
                    for($i=0;$i<$res->num_rows;$i++) {
                        ...
                        <tr>
                            ...
                            <td><button name="flowerType" type="submit" value="'.$row->ID. ' dress" style="color: white; background-color: #7a0202;" id="openform2" >Edit</button></td>
                        </tr>';
                        }
                        else{
                            $u = $row->URL;
