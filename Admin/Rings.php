...
if(isset($_POST['add'])){
    ...
    if ($error == 0) {
        ...
        if (in_array($img_ex_lc, $allowed_exs)) {
            ...
            $query = "INSERT INTO ring (URL, name, price)
...
<ul id="slide-out" class="side-nav fixed z-depth-2">
    <li class="center no-padding">
        <div class="indigo darken-2 white-text" style="height: 180px; background-color: #7a0202 ; color: #ffffff">
...
<header>
    ...
    <nav >
        <div class="nav-wrapper bg-secondary text-white "  style="background: #0e0e0e" >
            ...
            <a class="breadcrumb" style="color: #ffffff">T-shirt</a>
...
<main>
    ...
    <div class="form-popup" id="myForm1" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Add Ring</a>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-container" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="button" name="add" value="motherpic">Add</button>
    ...
    <div class="form-popup2" id="myForm2" style="padding: 30px">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-container2">
            ...
            <button type="button" class="button" style=" background-color: #8b8d78;"
                    onclick="document.getElementById('id01').style.display='block'">Delete</button><br>

            <button type="button" class="button" id="closeForm2" style=" background-color: #8b8d78; margin-top: 10px"
    ...
    <div id="mainDiv" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px"> T-shirt Table</a>
        ...
        <table id="table">
            ...
            <form action="editPic.php" method="post">
                ...
                try{
                    $db = mysqli_connect('localhost', 'root', '', 'special');
                    $qryStr= "select * from ring";
                    $res= $db->query($qryStr);
                    if ($db->connect_errno) {
                        printf("Connect failed: %s\n", $db->connect_error);
                        exit();
                    }
                    if ($result = $db->query($qryStr)) {
                        // $result is an object and can be used to fetch row here
                        printf("Query sucss: %s\n", $db->error);
                    }
                    else {
                    ...
                    for($i=0;$i<$res->num_rows;$i++) {
                        ...
                        <tr>
                            ...
                            <td><button name="flowerType" type="submit" value="'.$row->ID. ' ring" style="color: #ffffff; background-color: #7a0202;" id="openform2" >Edit</button></td>
                        </tr>';
                        }
                        else{
                            $u = $row->URL;
...
<div id="id01" class="modal">
    ...
    <form class="modal-content" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="container">
            <h5>Delete Order</h5>
            <p>Are you sure you want to delete this ring?</p>
