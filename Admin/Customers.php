...
<head>
    ...
    <title> Little Princess | Customers </title>
...
<header>
    <nav >
        <div class="nav-wrapper bg-secondary text-white "  style="background: #0e0e0e" >
            ...
            <a class="breadcrumb" style="color: #ffffff">Customers </a>
...
<main>
    ...
    <div class="form-popup" id="myForm1" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Add Customer</a>
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-container" method="post" enctype="multipart/form-data">
            ...
            <div class="col-75">
                ...
                <input type="text" name="LoginName" placeholder="Your name.." required>
                <label for="Phone"><b>Phone Number</b></label>
                <input type="text" name='Phone' placeholder="Enter phone number" pattern="[0-9]{10}" required>
            ...
            <button type="submit" class="button" name="reg_user">Add</button>
    ...
    <div id="mainDiv" style="padding: 30px">
        <a style="color: #8b8d78; font-size: 30px">Customers Table</a>
                    ...
                    for($i=0;$i<$res->num_rows;$i++) {
                        ...
                        <tr>
                            ...
                            <td><button type="submit"
                             style="color: white; background-color: #7a0202 ; " id="openform2" name="edit" value=" ' .$row->id.' ">Delete</button></td>
                        </tr>';
                    }
                }
                catch (Exception $e){
