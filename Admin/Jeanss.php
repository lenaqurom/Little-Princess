...
if(isset($_POST['add'])){
    ...
    if ($error == 0) {
        ...
        if (in_array($img_ex_lc, $allowed_exs)) {
            ...
            $query = "INSERT INTO flower (URL, name, price)
...
<header>
    ...
    <nav >
        <div class="nav-wrapper bg-secondary text-white "  style="background: #0e0e0e" >
            ...
            <a class="breadcrumb" style="color: #ffffff">Jeans</a>
...
<main>
    ...
    <div class="form-popup" id="myForm1" style="padding: 30px">
        <a style="color: #0e0e0e ; font-size: 30px">Add Product</a>
    ...
    <div id="mainDiv" style="padding: 30px">
        <a style="color: #0e0e0e; font-size: 30px">Jeans Table</a>
                ...
                try{
                    ...
                    for($i=0;$i<$res->num_rows;$i++) {
                        ...
                        <tr>
                            ...
                            <td><button name="flowerType" type="submit" value="'.$row->ID. ' flower" style="color: white; background-color: #7a0202;" id="openform2" >Edit</button></td>
                        </tr>';
                        }
                        else{
                            $u = $row->URL;
                        ...
                        <tr>
                            ...
                            <td><button name="flowerType" type="submit" value="'.$row->ID. ' flower" style="color: #ffffff; background-color: #7a0202;" id="openform2" >Edit</button></td>
                        </tr>';
                        }
                    }
                }
...
<div id="id01" class="modal">
    ...
    <form class="modal-content" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="container">
            <h5>Delete Order</h5>
            <p>Are you sure you want to delete this cart-invitation?</p>
